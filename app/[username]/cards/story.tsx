  ...
  return (
    <>
      <div
        ...
        className="w-full h-full group p-0 rounded-lg shadow relative overflow-hidden transition-transform duration-150 cursor-pointer ease-in hover:scale-[0.97]"
      >
        <Image
          {...buildImage(stories[0].image)}
          width={360}
          height={360}
          alt={stories[0].title || "a story image"}
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-neutral-50/40 flex items-end px-4 py-2 group-hover:opacity-20 transition-opacity">
          <h3 className="font-serif text-3xl text-neutral-700 font-light mb-2 font-serif-variation">{stories[0].title}</h3>
        </div>
      </div>
            ...
            <div className="fixed inset-0 z-[1000]">
              ...
              <div className="w-full h-full flex items-center justify-center px-2">
                <motion.div
                  ...
                  initial={{ scale: 0.9, opacity: 0 }}
                  animate={{ scale: 1, opacity: 1 }}
                  className="bg-white w-full max-w-sm h-[65vh] p-0.5 mx-1 rounded-xl shadow-[0px_0px_50px_-12px_rgba(0,0,0,0.5)]"
                >
                  <Stories stories={stories} />
                </motion.div>
              </div>
